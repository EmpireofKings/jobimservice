...
public class StatusMonitor {
    ...
    /**
     * Status of the different components (that advanced Latin proficiency exam finally pays off...)
     */
    ...
    /**
     * Prints a report about the status of the different components
    ...
    /**
     * Prints an HTML report about the status of the different components
    ...
    /**
     * Creates a report about the status of the different components as an object (useful for marshalling)
    ...
    public static class HealthReport{
        ...
        /**
         * Constructor for HealthReport that sets status as Strings
